...
<div class="row">
    <div class="col-md-6 col-xl-3">
        <div class="card-box tilebox-one">
            ...
            <span class="badge badge-success mr-1"> +11% </span> <span class="text-muted">From
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card-box tilebox-one">
            ...
            <span class="badge badge-danger mr-1"> -29% </span> <span class="text-muted">From
                previous period</span>
        </div>
    </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card-box tilebox-one">
            ...
            <span class="badge badge-pink mr-1"> 0% </span> <span class="text-muted">From previous
                period</span>
        </div>
    </div>
